            ...
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    <div>
                        ...
                        <input type="text" v-model="form.username" placeholder="логин" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>
                    ...
                    <div>
                        <label>Имя</label><br>
                        <input type="text" v-model="form.first_name" placeholder="имя" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>

                    <div>
                        <label>Фамилия</label><br>
                        <input type="text" v-model="form.last_name" placeholder="фамилия" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>
